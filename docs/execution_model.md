...
respectively, and another launch requires clear/reset. Full RTL realization
remains part of divergence and reconvergence integration, but the model contract
is frozen here.
