...
| Kernel done requires all warps exited and complete machine drain | Single-warp drain logic complete; multi-warp controller planned | Integer and lifecycle integration tests | Multi-warp quiescence properties pending | Final event × outstanding structure pending | Partial: single-warp drain verified |
